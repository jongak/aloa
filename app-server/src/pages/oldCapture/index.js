...
const capture = function () {
  ...
  const rarityPreset = useSelector((state) => state.rarityPreset);
  const characterNameRef = useRef();

  const dispatch = useDispatch();
  const navigate = useNavigate();
  const isHolo = useSelector((state) => state.isHolo);
  const isGlow = useSelector((state) => state.isGlow);
  const isShine = useSelector((state) => state.isShine);
  const isShadow = useSelector((state) => state.isShadow);
  const frontItems = useSelector((state) => state.frontItems);
  const frontIcons = useSelector((state) => state.frontIcons);
  const optionItems = useSelector((state) => state.optionItems);
